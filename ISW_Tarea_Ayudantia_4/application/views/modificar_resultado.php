...
<body>
    <div id="encabezado">
        ...
        <section>
            <div id="texto">
                <?= form_open(base_url()."proyecto_isw/modificar") ?>
                  <?php
                    $id = array(
                        'name' => 'id',
                        'value' => $query->Id_Administrador
                    );
                    $usuario = array(
                        'name' => 'usuario',
                        'Placeholder' => $query->Usuario,
                    );
                    $pass = array(
                        'name' => 'pass',
                        'Placeholder' => $query->Contrasenia,
                        'type' => 'password'
                    );
                    $nombre1 = array(
                        'name' => 'nombre1',
                        'Placeholder' => $query->Nombre1
                    );
                    $nombre2 = array(
                        'name' => 'nombre2',
                        'Placeholder' => $query->Nombre2
                    );
                    $apellido1 = array(
                        'name' => 'apellido1',
                        'Placeholder' => $query->Apellido1
                    );
                    $apellido2 = array(
                        'name' => 'apellido2',
                        'Placeholder' => $query->Apellido2
                    );
                    $rut = array(
                        'name' => 'rut',
                        'Placeholder' => $query->Rut
                    );
                    $correo = array(
                        'name' => 'correo',
                        'Placeholder' => $query->Correo,
                        'type' => 'email'
                    );
                    $cargo = array(
                        'name' => 'cargo',
                        'Placeholder' => $query->Cargo
                    );
                    if($query->Sexo == TRUE) {
                        $temp = 'Masculino';
                    }
                    ...
                    $comuna = array(
                        'name' => 'comuna',
                        'Placeholder' => $query->Comuna
                    );
                    $direccion = array(
                        'name' => 'direccion',
                        'Placeholder' => $query->Direccion
                    );
                    $fecha = array(
                        'name' => 'fecha',
                        'Placeholder' => $query->Fecha_Nacimiento,
                        'type' => 'date'
                    );
                    $telefono1 = array(
                        'name' => 'telefono1',
                        'Placeholder' => $query->Telefono1
                    );
                    $telefono2 = array(
                        'name' => 'telefono2',
                        'Placeholder' => $query->Telefono2
                    );
                ?>
                    ...
                    <?= form_label($temp,'sexo2')?><br/>
                    <?= form_dropdown($sexo,$opciones)?><br/>
